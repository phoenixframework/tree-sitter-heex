...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [295] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_quoted_attribute_value, 2),
  [297] = {.entry = {.count = 1, .reusable = false}}, SHIFT(82),
  [299] = {.entry = {.count = 1, .reusable = false}}, SHIFT(92),
  [301] = {.entry = {.count = 1, .reusable = false}}, SHIFT(64),
  ...
  [365] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_partial_expression_value, 2),
  [367] = {.entry = {.count = 1, .reusable = false}}, SHIFT(85),
  [369] = {.entry = {.count = 1, .reusable = false}}, SHIFT(76),
  [371] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__hash_comment_repeat1, 2), SHIFT_REPEAT(76),
  [374] = {.entry = {.count = 1, .reusable = false}}, SHIFT(89),
  [376] = {.entry = {.count = 1, .reusable = false}}, SHIFT(24),
  [378] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_expression_repeat1, 1),
  [380] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_expression_repeat1, 1),
  [382] = {.entry = {.count = 1, .reusable = false}}, SHIFT(28),
  [384] = {.entry = {.count = 1, .reusable = false}}, SHIFT(87),
  [386] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_partial_expression_value, 4),
  [388] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__html_comment_repeat1, 2), SHIFT_REPEAT(81),
  [391] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_partial_expression_value, 1),
  [393] = {.entry = {.count = 1, .reusable = false}}, SHIFT(75),
  [395] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__expression_value, 2),
  [397] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__expression_value, 2),
  [399] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_partial_expression_value, 3),
  ...
  [417] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_partial_expression_value, 2),
  [419] = {.entry = {.count = 1, .reusable = true}}, SHIFT(86),
  [421] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_partial_expression_value, 1),
  ...
  [449] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_special_attribute_name, 1),
